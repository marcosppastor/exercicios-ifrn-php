...
<body>
    ...
    <hr>
    <div>
        <h4>1) Construir um algoritmo que leia 2 números e efetue a adição. Caso o valor somado seja maior que 20, este deverá ser apresentando
            somando-se a ele mais 8; caso o valor somado seja menor ou igual a 20, este deverá ser apresentado subtraindo-se 5</h4>
        <?php
        $numAleatorioum1 = 1;
        $numAleatorioum2 = 5;
        $limite = 20;
    ...
    <hr>
    <div>
        <h4>2) Entrar com um número e informar se ele é divisível por 10, por 5, por 2 ou se não é divisível por nenhum destes</h4>
        <?php
        $numDividir = 92;
    ...
    <hr>
    <div>
        <h4>3) Entrar com nome, sexo e idade de uma pessoa. Se a pessoa for do sexo feminino e tiver menos que 25 anos, imprimir nome e a
            a mensagem: ACEITA. Caso contrário, imprimir nome e a mensagem: NÃO ACEITA.</h4>
        <?php
        $nomePessoa = "Danielle";
        $sexoPessoa = "feminino";
        $idadePessoa = 24;
    ...
    <hr>
    <div>
        <h4>4) Entrar com 3 números e imprimi-los em ordem decrescente (suponha números diferentes)</h4>
        <?php
    ...
    <hr>
    <div>
        <h4>5) Ler 3 números, os possíveis lados de um triângulo, e imprimir a classificação de acordo com tamanho dos lados</h4>
        <?php
        $triangulo1 = 1;
        $triangulo2 = 2;
        $triangulo3 = 5;
    ...
    <hr>
    <div>
        <h4>6) Ler um número inteiro entre 1 e 12 e escrever o mês correspondente. Caso o número seja fora desse intervalo, informar que não existe
            mês com este número</h4>
        <?php
        $meses = [
            "Janeiro", "Fevereiro",
            "Março", "Abril",
    ...
    <hr>
    <div>
        <h4>7) A biblioteca de uma universidade deseja fazer um algoritmo que leia o nome do livro que será emprestado, o tipo de usuário (professor
    ...
    <hr>
    <div>
        <h4>8) Criar um algoritmos que leia um número e imprima todos os número de 1 até ele e o seu produto</h4>
        <?php
        $produtos = [
            1 => "1 - Livro<br>",
            2 => "2- Banana<br>",
    ...
    <hr>
    <div>
        <h4>9) Entrar com o número de vezes que se deseja imprimir a palavra SOL e imprimir</h4>
        <?php
    ...
    <hr>
    <div>
        <h4>10) Entrar com 20 números e imprimir a soma dos positivos e o total de números negativos</h4>
        <?php
        $resultado = [
            0 => 0,
            1 => 0
    ...
    <hr>
    <div>
        <h4>11) Criar um algoritmos que imprima a tabuada de um número</h4>
        <?php
        $tabuadaDe = rand(1, 10);
    ...
    <hr>
    <div>
        <h4>12) Criar um algoritmos que entre com uma palavra e imprima conforme o exemplo:</h4>
        <li>Palavra: sonho</li>
        <li>SONHO</li>
        <li>SONHO SONHO</li>
    ...
    <hr>
    <div>
        <h4>13) Ler vários números e informar quantos números entre 100 e 200 foram digitados. Se o valor 0 for lido encerrar a execução</h4>
        <?php
        $resultado = [
            0 => 0,
            1 => 0
    ...
    <hr>
    <div>
        <h4>14) Chico tem 1,50m e cresce 2 centímetros por ano, enquanto Juca tem 1,10m e cresce 3 centímetros por ano. Construir um algoritmos
            que calcule e imprima quantos anos serão necessários para que Juca seja maior que Chico</h4>
        <?php
        $anos = 0;
        $nome1 = "Chico";
        $nome2 = "Juca";
